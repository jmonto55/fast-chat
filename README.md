...
# 📖 FastChat <a name="about-project"></a>
...
```
cd my-folder
git clone https://github.com/jmonto55/fast-chat.git
```
...
If you like this project feel free to frok it and use it as you need and star the repository.
